...
/**
 * The Claw mechanism of the outtake system.
 *
...
class Claw(hardwareMap: HardwareMap) : ServoPositionMechanism(close) {
     ...
     */
    override val servos : Array<Servo> = arrayOf(hardwareMap.servo["Outtake Claw"])
    /**
 ...
 */
@TeleOp(name = "Outtake Claw Position Test", group = "D")
@Disabled
